...
export default function ButtonSheet({ dispatch, children, height, bottom = 0, onClose }: ButtonSheetProps) {
		...
		<View>
			<Modal animationType="slide" transparent={true} visible={dispatch}>
				<View style={styles.centeredView}>
					<TouchableOpacity activeOpacity={0.1} onPress={onClose} style={styles.modalOverlay} />
