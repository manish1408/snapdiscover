				...
				>
					...
					<View>
						<View style={{ marginBottom: normalize(24) }}>
							<Input label="newAddress.name" placeholder="newAddress.namePlaceholder" />
						</View>
						<View style={{ marginBottom: normalize(24) }}>
							<Input label="newAddress.address" placeholder="newAddress.addressPlaceholder" rightIcon={<Icon icon={location} />} />
						</View>
						<View style={styles.checkboxContainer}>
							<CheckBox value={check} onChange={setCheck} />
							<Typography style={{ marginLeft: normalize(10) }}>newAddress.checkboxText</Typography>
						</View>
					</View>
