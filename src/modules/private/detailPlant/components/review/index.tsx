		...
		<View style={{ marginBottom: normalize(24) }}>
			...
			<View style={{ marginTop: normalize(12) }}>
				<Typography style={styles.description} translate={false}>
					Always top notch on there order process. Gives quality plants and always handle shipments pretty well. I do love ordering rare plants with
					them. Been partner with them for 2 years now and I will always order my collection trough them. Thank you so much!
				</Typography>
			</View>
